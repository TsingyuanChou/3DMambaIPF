...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt', type=str, default='./pretrained/denoisenet-epoch99-val_loss0.000265.ckpt')
    #parser.add_argument('--ckpt', type=str, default='./pretrained/denoisenet-epoch84-val_loss0.000266.ckpt')
    ...
    parser.add_argument('--noise_lvls', type=str, default='0.01') # Set your test noise level
    parser.add_argument('--device', type=str, default='cuda')
    parser.add_argument('--seed', type=int, default=2020)

    # Filtering parameters
    parser.add_argument('--patch_size', type=int, default=2000) # 1000 for small PCL, 2000 for large PCL
    ...
    parser.add_argument('--seed_k_alpha', type=int, default=20) # 10 for small PCL, 20 for large PCL and RueMadame PCL
